...
function App() {
  ...
  return (
    <div className="bg-gradient-to-b from-slate-950 via-slate-900 to-black text-white min-h-screen">
      ...
      <section
        id="home"
        className="max-w-7xl mx-auto px-8 pt-40 pb-24 grid md:grid-cols-2 gap-16 items-center"
      >
        ...
        <div className="flex justify-center">
          ...
          <div className="relative">
            ...
            <img
              src={profile}
              alt="profile"
              className="relative w-[350px] h-[450px] object-cover rounded-[35px] border-4 border-slate-800 shadow-2xl hover:scale-105 transition duration-500"
            />
      ...
      >
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-10 rounded-3xl backdrop-blur-md">
      ...
      <section className="max-w-6xl mx-auto px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          ...
          {[
            ...
            <div
              key={index}
              className="bg-slate-900 border border-slate-800 rounded-3xl p-7 text-center hover:border-cyan-400 hover:-translate-y-3 transition duration-300 shadow-xl"
            >
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          {[
            ...
            <div
              key={index}
              className="bg-slate-900/70 border border-slate-800 p-8 rounded-3xl hover:border-cyan-400 hover:-translate-y-2 transition duration-300 shadow-xl"
            >
      ...
      >
        ...
        <div className="bg-slate-900/70 border border-slate-800 rounded-3xl p-12 text-center shadow-xl">
